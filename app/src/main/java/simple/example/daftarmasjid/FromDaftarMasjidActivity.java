...
public class FromDaftarMasjidActivity extends AppCompatActivity {
    ...
    final String[] tipeFavorite = {DaftarMasjid.Masjid,DaftarMasjid.Mushola};

    @Override
    protected void onCreate (Bundle savedInstanceState) {
        super.onCreate (savedInstanceState);
        setContentView (R.layout.activity_from_daftar_masjid);
        inisialisasiView();
    }
